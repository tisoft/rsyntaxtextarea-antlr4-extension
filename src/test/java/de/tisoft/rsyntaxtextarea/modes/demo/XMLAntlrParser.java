...
import third_party.XMLParser;

public class XMLAntlrParser extends AntlrParserBase<XMLLexer, XMLParser> {
  @Override
  protected XMLLexer createLexer(CharStream input) {
    return new XMLLexer(input);
  }

  @Override
  protected XMLParser createParser(TokenStream input) {
    return new XMLParser(input);
  }

  @Override
  protected void parse(XMLParser parser) {
    parser.document();
  }
}
